choice='n'
condition=choice != 'y' #flag is boolean which means its can have value as True/False
while condition:        # n not equal to y --> true #if user enters choice = y , y!=y --> False
