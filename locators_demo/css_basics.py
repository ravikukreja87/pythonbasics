...
class CSSBasics(unittest.TestCase):
    ...
    def test_navigate_agile(self):
        ...
        checkbox_one = self.driver.find_element(by=By.CSS_SELECTOR, value="input[type=checkbox]:nth-child(1)")
        checkbox_two = self.driver.find_element(by=By.CSS_SELECTOR, value="input[type=checkbox]:nth-child(3)")
        time.sleep(2)
        checkbox_one.click()
        time.sleep(2)
        checkbox_two.click()
